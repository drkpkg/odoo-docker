...
# Replace host all all all scram-sha-256 with host    all             odoo            odoo9-net                trust
sed -i 's/host all all all scram-sha-256/host    all             odoo            odoo9-net                trust/g' /var/lib/postgresql/data/pg_hba.conf